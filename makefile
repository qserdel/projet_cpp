...
robot.o: robot.cpp robot.hpp balle.hpp parametres.hpp
...
# Tests
tests_catch: tests_catch_balle.o balle.o tests_catch_collision.o collision.o tests_catch_jeu.o jeu.o tests_catch_map.o map.o menu.o tests_catch_robot.o robot.o bouclier.o collectable.o grandir.o map.o rapetisser.o reparer.o
